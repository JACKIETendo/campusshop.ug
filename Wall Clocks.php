...
<head>
    ...
    <title>Bugema CampusShop - Wall Clocks</title>
    ...
    <style>
        * {
        ...
        /* Enhanced popup design for larger screens */
        .image-modal-grid {
            display: grid;
        ...
        <div class="container">
            ...
            <nav>
                <ul class="nav-links">
                    ...
                    <li><a href="Wall Clocks.php" class="active">Wall Clocks</a></li>
            ...
            <div class="mobile-menu">
                ...
                <div class="mobile-nav">
                    ...
                    <a href="Wall Clocks.php" class="active">Wall Clocks</a>
        ...
        <div class="modal-content image-modal-content">
            ...
            <div class="image-modal-grid">
                ...
                <div class="image-modal-right">
                    ...
                    <form method="POST" action="Wall Clocks.php" id="modal-form" class="modal-form">
