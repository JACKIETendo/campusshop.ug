...
<body>
    <header>
        <div class="container">
            ...
            <div class="mobile-menu">
                ...
                <?php if (isset($_SESSION['username'])): ?>
                    <span class="mobile-username"><a href="profile.php" class="username">Hi, <?php echo htmlspecialchars($_SESSION['username']); ?></a></span>
                <?php endif; ?>
    ...
    <div class="modal" id="image-modal">
        <div class="modal-content image-modal-content">
            ...
            <form method="POST" action="Bottles.php" id="modal-form">
